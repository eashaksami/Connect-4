...
def WinningState(gameState):
    ...
    for i in range(6):
        for j in range(7):
            if gameState[5 - i][j] == 'x':
                if gameState[5 - i - 1][j] == 'x' and totalInARow < 4: # array index out of bound
                    totalInARow+=1
                    if totalInARow == 3:
                        totalInARow+=1
                        return 1000
                ...
                if gameState[5 - i - 1][j] == 'o' and totalInARow < 4:
                    totalInARow += 1
                    if totalInARow == 3:
                        totalInARow += 1
                        return 1000
    ...
    for i in range(6):
        for j in range(7):
            if gameState[5 - i][6 - j] == 'x':
                if gameState[5 - i][6 - j - 1] == 'x' and totalInARow < 4:
                    totalInARow += 1
                    if totalInARow == 3:
                        totalInARow += 1
                        return 1000
            ...
            elif gameState[5 - i][6 - j] == 'o':
                if gameState[5 - i][6 - j - 1] == 'o' and totalInARow < 4:
                    totalInARow += 1
                    if totalInARow == 3:
                        totalInARow += 1
                        return 1000
    ...
    for i in range(6):
        for j in range(7-1):
            if gameState[5 - j][j] == 'x':
                if gameState[5 - j - 1][j + 1] == 'x' and totalInARow < 4:
                    totalInARow+=1
                    if totalInARow == 3:
                        totalInARow+= 1
                        return 1000
    ...
    for i in range(6):
        for j in range(7 - 1):
            if gameState[5 - j][6 - j] == 'x':
                if gameState[5 - j - 1][6 - j - 1] == 'x' and totalInARow < 4:
                    totalInARow += 1
                    if totalInARow == 3:
                        totalInARow += 1
                        return 1000
...
boardState = getBoard()
availableMoves = [6, 6, 4, 5, 5, 6, 6]
state = Minimax(boardState, False, availableMoves)
print("in main")
print(state)'''
